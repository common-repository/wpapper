...
abstract class WP_JSON_Meta {
	...
	public function register_routes( $routes ) {
		$routes[ $this->route] = array(
			"get_all_meta" => array( array( $this, 'get_all_meta' ),   WP_JSON_Server::READABLE ),
			"add_meta" => array( array( $this, 'add_meta' ),       WP_JSON_Server::CREATABLE | WP_JSON_Server::ACCEPT_JSON ),
			"get_meta"=> array( array( $this, 'get_meta' ),       WP_JSON_Server::READABLE ),
			"update_meta" => array( array( $this, 'update_meta' ),    WP_JSON_Server::EDITABLE | WP_JSON_Server::ACCEPT_JSON ),
			"delete_meta" => array( array( $this, 'delete_meta' ),    WP_JSON_Server::DELETABLE ),
		);
	...
	public function add_meta( $id, $data ) {
		...
		$response = wpapper_json_ensure_response( $this->get_meta( $id, $result ) );
