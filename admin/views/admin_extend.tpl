...
<div class="wrap control-section wp-admin wp-core-ui js  nav-menus-php auto-fold admin-bar branch-4-2 version-4-2-2 admin-color-fresh locale-zh-cn customize-support svg menu-max-depth-0" id="wpbody-content">
	<div id="uz">
        ...
        <!--
		<ul class="subsubsub">
			<li>Version：V<span class="tpl-version"><%version%></span> |</li>
			<li>Last update：<span class="tpl-updatetime"><%updatetime%></span> | </li>
  ...
  <table class="tb tb2">
    <tr>
      ...
      <td class='tips2'>（必填）IOS链接地址，如：http://wpapper.com/</td>
    </tr>
