...
class WpApperConf{
    ...
    public static $app_prefix = 'wpapper_app';                               //yz 标识
    ...
    public static $page_alias = 'wpapper_admin';                         //页面的别名
    ...
    //mc 配置
    public static $bigapp_home_url = "http://wpapper.com";                 //站长中心地址
    //获取线上发布的最新版本的信息
    public static $mc_url_app_version_info = "http://wpapper.com:8080/mc/mcapi/getLineVersion";
    public static $taskInfoUrl = 'http://wpapper.com:8080/mc/mcapi/get_latest';
    public static $appInfoUrl = 'http://wpapper.com:8080/mc/mcapi/get_basic';
    public static $releaseApis = array(
		 'latest_package' => 'http://wpapper.com:8080/product/ui/http/index.php?module=mc&controller=appversion&method=get_latest_package',
    );
